...
function AboutContent() {
  return (
    <>
      ...
      >
        I&lsquo;m a 20 year old software developer from <OT>India</OT>, and I
        like making useful things!
        <br />
        It all started when I was <OT>16</OT>, and the first language I used was{" "}
        <OT>Java</OT>.
        <br /> <br />
        Over the years I&lsquo;ve picked up many <OT>new skills</OT> and worked
        with many different languages and frameworks.
        <br />I love learning about new things, and my curiosity has led me to
        playing around with esoteric languages like <OT>Haskell</OT> and editors
        like <OT>Vim</OT> and <OT>Emacs</OT>.
        <br /> <br />
        However, my focus is currently on:
        <br />• <OT>Mobile App Development</OT>
        {" - "}either native Android apps using <OT>Kotlin</OT>, or with{" "}
        <OT>Flutter</OT> or <OT>React Native</OT>.
        <br />• <OT>Web Development</OT>
        ...
        <br /> <br />
        I&lsquo;m also a <OT>Linux enthusiast</OT> and have spent a considerable
        amount of time messing with <OT>kernels</OT>.
        <br /> <br />
